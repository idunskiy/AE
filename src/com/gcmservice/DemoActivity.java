...
public class DemoActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.gcm_demo_main);
	...
	private boolean checkPlayServices() {
		...
		if (resultCode != ConnectionResult.SUCCESS) {
			if (GooglePlayServicesUtil.isUserRecoverableError(resultCode)) {
				...
				Toast.makeText(getApplicationContext(), "This device is not supported for receiving messages from Google Cloud Messaging.", Toast.LENGTH_SHORT).show();
			}
			return false;
		}
		return true;
	  ...
	  private final class SendRegistrationIdTask extends  AsyncTask<String, Void, JSONObject> {
			    ...
			    protected void onPostExecute(JSONObject response) {
			      if (response == null) {
			        ...
			        mDisplay.setText(response.toString());
			        return;
			      }
